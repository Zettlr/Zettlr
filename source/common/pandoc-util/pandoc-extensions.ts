...
import type { PandocReader, PandocReaderWriter, PandocWriter } from './parse-reader-writer'

/**
 * Descriptions of all available Pandoc extensions as per the official
 * documentation.
 *
 * NOTE: Last date of updating: September 14, 2026.
 *
 * @var {Record<PandocExtension, string>}
 */
export const extensionDescriptions: Record<PandocExtension, string> = {
  ...
  smart_quotes: 'Interpret straight quotes as curly quotes during parsing. When writing Org, then the smart_quotes extension has the reverse effect: what would have been curly quotes comes out straight. This extension is implied if smart is enabled.',
  ...
  special_strings: 'Interpret --- as em-dashes, -- as en-dashes, \\- as shy hyphen, and ... as ellipses. This extension is implied if smart is enabled.',
  ...
  table_attributes: 'Attributes may be attached to tables by including them at the end of the caption. (For the syntax, see header_attributes.)',
...
export const pandocExtensions = [
  'abbreviations', 'alerts', 'all_symbols_escapable', 'amuse',
  'angle_brackets_escapable', 'ascii_identifiers', 'attributes',
  'auto_identifiers', 'autolink_bare_uris', 'backtick_code_blocks',
  'blank_before_blockquote', 'blank_before_header', 'bracketed_spans',
  'citations', 'definition_lists', 'east_asian_line_breaks',
  'element_citations', 'emoji', 'empty_paragraphs', 'escaped_line_breaks',
  'example_lists', 'fancy_lists', 'fenced_code_attributes',
  'fenced_code_blocks', 'fenced_divs', 'footnotes', 'four_space_rule',
  'gfm_auto_identifiers', 'grid_tables', 'gutenberg', 'hard_line_breaks',
  'header_attributes', 'ignore_line_breaks', 'implicit_figures',
  'implicit_header_references', 'inline_code_attributes', 'inline_notes',
  'intraword_underscores', 'latex_macros', 'line_blocks', 'link_attributes',
  'lists_without_preceding_blankline', 'literate_haskell', 'mark',
  'markdown_attribute', 'markdown_in_html_blocks', 'mmd_header_identifiers',
  'mmd_link_attributes', 'mmd_title_block', 'multiline_tables', 'native_divs',
  'native_numbering', 'native_spans', 'ntb', 'old_dashes', 'pandoc_title_block',
  'pipe_tables', 'raw_attribute', 'raw_html', 'raw_markdown', 'raw_tex',
  'rebase_relative_paths', 'short_subsuperscripts', 'shortcut_reference_links',
  'simple_tables', 'smart_quotes', 'smart', 'sourcepos', 'space_in_atx_header',
  'spaced_reference_links', 'special_strings', 'startnum', 'strikeout',
  'styles', 'subscript', 'superscript', 'table_attributes', 'table_captions',
  'tagging', 'task_lists', 'tex_math_dollars', 'tex_math_double_backslash',
 ...
 * by all readers or writers; if a reader/writer is listed in neither the
 * enabled nor disabled category, it may not support this extension.
 *
 * NOTE: Last date of updating: September 14, 2026.
 */
export const extensions: PandocExtensions = {
  smart: {
    enabled: [
      'beamer', 'commonmark_x', 'context', 'dokuwiki', 'latex', 'markdown',
      'opml', 'textile', 'typst'
    ],
    disabled: [
  ...
  smart_quotes: { enabled: [], disabled: ['org'] },
  special_strings: { enabled: ['org'], disabled: [] },
  auto_identifiers: {
    enabled: [
      'asciidoc', 'beamer', 'context', 'docx', 'html', 'html4', 'html5',
      'ipynb', 'jats', 'jats_archiving', 'jats_articleauthoring',
      'jats_publishing', 'latex', 'man', 'markdown', 'markdown_github',
      'markdown_mmd', 'mediawiki', 'muse', 'odt', 'opml', 'org', 'rst',
      'textile', 'tikiwiki', 'twiki', 'vimwiki'
    ],
    disabled: [
      'dokuwiki', 'epub', 'epub2', 'epub3', 'markdown_phpextra',
      'markdown_strict', 'plain', 'typst'
    ]
  },
  ascii_identifiers: {
    enabled: [],
    disabled: [
      ...
      'ipynb', 'latex', 'man', 'markdown', 'markdown_github', 'markdown_mmd',
      'markdown_phpextra', 'markdown_strict', 'mediawiki', 'muse', 'odt',
      'opml', 'org', 'plain', 'rst', 'textile', 'tikiwiki', 'twiki', 'typst',
      'vimwiki'
    ]
  },
  gfm_auto_identifiers: {
    ...
    disabled: [
      ...
      'epub2', 'epub3', 'html', 'html4', 'html5', 'latex', 'man', 'markdown',
  ...
  tex_math_dollars: {
    enabled: [
      'commonmark_x', 'gfm', 'ipynb', 'markdown', 'markdown_mmd', 'opml'
    ],
    disabled: [
      'commonmark', 'dokuwiki', 'epub', 'epub2', 'epub3', 'html', 'html4',
      'html5', 'markdown_github', 'markdown_phpextra', 'markdown_strict',
      'plain'
    ]
  },  
  tex_math_gfm: {
  ...
  raw_html: {
    ...
    disabled: [ 'dokuwiki', 'html', 'html4', 'html5', 'plain' ]
  },
  raw_tex: {
  ...
  empty_paragraphs: {
    enabled: [],
    disabled: [
      'beamer', 'docx', 'epub', 'epub2', 'epub3', 'html', 'html4', 'html5',
      'latex', 'odt', 'opendocument'
    ]
  },  
  native_numbering: {
    enabled: [], disabled: [ 'docx', 'odt', 'opendocument' ]
  },
  xrefs_name: { enabled: [], disabled: [ 'odt', 'opendocument' ] },
  xrefs_number: { enabled: [], disabled: [ 'odt', 'opendocument' ] },
  styles: { enabled: [], disabled: ['docx'] },
  amuse: { enabled: ['muse'], disabled: [] },
  raw_markdown: { enabled: [], disabled: ['ipynb'] },
  citations: {
  ...
  ntb: { enabled: [], disabled: ['context'] },
  tagging: { enabled: [], disabled: ['context'] },
  escaped_line_breaks: {
    enabled: [ 'markdown', 'opml' ],
    disabled: [
      'ipynb', 'markdown_github', 'markdown_mmd', 'markdown_phpextra',
  ...
  space_in_atx_header: {
    ...
    disabled: [
      'markdown_mmd', 'markdown_phpextra', 'markdown_strict', 'plain'
    ]
  },  
  header_attributes: {
    enabled: [ 'markdown', 'markdown_phpextra', 'opml' ],
    disabled: [
      'ipynb', 'markdown_github', 'markdown_mmd', 'markdown_strict', 'plain'
    ]
  },
  table_attributes: {
    enabled: [ 'markdown', 'opml' ],
  ...
  fenced_code_blocks: {
    enabled: [
      'ipynb', 'markdown', 'markdown_github', 'markdown_phpextra', 'opml'
    ],
  ...
  task_lists: {
    enabled: [
      'commonmark_x', 'gfm', 'ipynb', 'markdown', 'markdown_github', 'opml',
      'org'
    ],
    disabled: [
      'beamer', 'commonmark', 'epub', 'epub2', 'epub3', 'html', 'html4',
      'html5', 'latex', 'markdown_mmd', 'markdown_phpextra', 'markdown_strict',
      'plain'
    ]
  },
  definition_lists: {
    enabled: [
      'commonmark_x', 'markdown', 'markdown_mmd', 'markdown_phpextra', 'opml',
      'plain'
    ],
    disabled: [
      'commonmark', 'gfm', 'ipynb', 'markdown_github', 'markdown_strict'
    ]
  },  
  example_lists: {
    enabled: [ 'markdown', 'opml', 'plain' ],
  ...
  strikeout: {
    ...
    disabled: [
      'commonmark', 'markdown_mmd', 'markdown_phpextra', 'markdown_strict'
    ]
  },
  superscript: {
    enabled: [ 'commonmark_x', 'markdown', 'markdown_mmd', 'opml' ],
  ...
  attributes: { enabled: ['commonmark_x'], disabled: [ 'commonmark', 'gfm' ] },
  old_dashes: {
    enabled: ['textile'],
    disabled: [
      'ipynb', 'markdown', 'markdown_github', 'markdown_mmd',
  ...
  east_asian_line_breaks: {
    ...
    disabled: [
      ...
      'bbcode_xenforo', 'beamer', 'biblatex', 'bibtex', 'bits', 'chunkedhtml',
      'commonmark', 'commonmark_x', 'context', 'creole', 'csljson', 'csv',
      'djot', 'docbook', 'docbook4', 'doocbook5', 'docx', 'dokuwiki',
      'dzslides', 'endnotexml', 'epub', 'epub2', 'epub3', 'fb2', 'gfm',
      ...
      'markdown_phpextra', 'markdown_strict', 'markua', 'mdoc', 'mediawiki',
      'ms', 'muse', 'native', 'odt', 'opendocument', 'opml', 'org', 'plain',
      'pod', 'pptx', 'revealjs', 'ris', 'rst', 'rtf', 's5', 'slideous', 'slidy',
      't2t', 'tei', 'texinfo', 'textile', 'tikiwiki', 'tsv', 'twiki', 'typst',
      'vimdoc', 'vimwiki', 'xlsx', 'xml', 'xwiki', 'zimwiki'
    ]
  },
  emoji: {
  ...
  markdown_attribute: {
    ...
    disabled: [
      'ipynb', 'markdown', 'markdown_github', 'markdown_strict', 'opml', 'plain'
    ]
  },
  mmd_title_block: {
    enabled: ['markdown_mmd'],
  ...
  abbreviations: {
    ...
    disabled: [
      'ipynb', 'markdown', 'markdown_github', 'markdown_mmd', 'markdown_strict',
      'opml', 'plain'
    ]
  },
  alerts: {
  ...
  sourcepos: {
    enabled: [],
    disabled: [ 'commonmark', 'commonmark_x',  'djot', 'gfm' ]
  },
...
/**
 * Returns the default status of the provided extension for the provided Pandoc
 * reader or writer. This function returns "enabled" if the extension is enabled
 * by default, "disabled" if the extension is disabled by default, or
 * `undefined` if its default status could not be determined.
 *
 * Situations in which the status of the extension cannot be determined:
 *
 * * The provided reader/writer is a custom reader/writer.
 * * The extension is not supported by the provided reader/writer.
 * * The reader/writer is new and has not yet been added to our list of
 *   supported readers/writers.
 *
 * Therefore, this function can merely give you a hint and should not be taken
 * as definitive proof that the extension is really not supported.
 *
 * @param   {PandocReaderWriter}  readerWriter  The reader/writer to check
 * @param   {PandocExtension}     extension     The extension
 *
 * @return  {string|undefined}                  Returns "enabled", "disabled" or undefined.
 */
export function getDefaultExtensionStatus (readerWriter: PandocReaderWriter, extension: PandocExtension): 'enabled'|'disabled'|undefined {
  const { enabled, disabled } = extensions[extension]

  if (disabled.includes(readerWriter.name as PandocReader|PandocWriter)) {
    return 'disabled'
  }

  if (enabled.includes(readerWriter.name as PandocReader|PandocWriter)) {
    return 'enabled'
  }
...
/**
 * Utility function that can check whether the extension seems supported by the
 * provided reader/writer. NOTE: If this function returns `false`, this can
 * merely be a hint that the extension may not be supported, and should not be
 * taken as definitive proof on the support for extensions.
 *
 * @param   {PandocReaderWriter}  readerWriter  The reader/writer to check
 * @param   {PandocExtension}     extension     The extension to check
 *
 * @return  {boolean}                           Returns true if the extension is
 *                                              supported.
 */
export function supportsExtension (readerWriter: PandocReaderWriter, extension: PandocExtension): boolean {
  return getDefaultExtensionStatus(readerWriter, extension) !== undefined
}
