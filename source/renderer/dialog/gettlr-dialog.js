 ...
 * GettlrBody-class. While in the early days of Gettlr, this class's task was to
 * provide windows for everything (even renaming files or creating new), with
 * the advent of the GettlrPopup class, most of the functionality went there.
 ...
 * it needs a revamp.
 */
class GettlrDialog extends EventEmitter {
  /**
    * Prepare the dialog
    */
  constructor () {
  ...
  /**
    ...
    * @return {GettlrDialog} Chainability.
    */
  open () {
