module.exports = {"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"dialog\">\n    <h1>"
    + alias3((helpers.i18n || (depth0 && depth0.i18n) || alias2).call(alias1,"update.title",{"name":"i18n","hash":{},"data":data}))
    + ": "
    ...
    + "</h1>\n    <p><strong>"
    + alias3((helpers.i18n || (depth0 && depth0.i18n) || alias2).call(alias1,"update.current_version",{"name":"i18n","hash":{},"data":data}))
    + ": "
    ...
    + "</strong></p>\n    <p>\n        "
    + alias3((helpers.i18n || (depth0 && depth0.i18n) || alias2).call(alias1,"update.notification",{"name":"i18n","hash":{},"data":data}))
    + "\n    </p>\n    <div class=\"changelog\">\n        "
    ...
    + alias3((helpers.i18n || (depth0 && depth0.i18n) || alias2).call(alias1,"update.release_url",{"name":"i18n","hash":{},"data":data}))
    + "</a>\n    <button id=\"abort\">"
    + alias3((helpers.i18n || (depth0 && depth0.i18n) || alias2).call(alias1,"update.close",{"name":"i18n","hash":{},"data":data}))
    + "</button>\n</div>\n";
},"useData":true}