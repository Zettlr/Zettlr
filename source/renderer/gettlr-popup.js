 ...
 * BEGIN HEADER
 *
 * Contains:        GettlrPopup class
 * CVM-Role:        Model
 * Maintainer:      Hendrik Erz
 * License:         GNU GPL v3
 *
 * Description:     Displays a popup to the target element.
 *                  GettlrPopup features a class that can be instantiated to
...
/**
 * This is the native enemy of the GettlrDialog class, because it just snatched
...
class GettlrPopup {
  ...
  _onClickHandler (event) {
    ...
    // https://github.com/Gettlr/Gettlr/issues/554
...
module.exports = function (element, content, callback = null) {
  return new GettlrPopup(element, content, callback)
}
