...
PANDOC_LINUX_X64="https://github.com/jgm/pandoc/releases/download/2.13/pandoc-2.13-linux-amd64.tar.gz"
PANDOC_LINUX_ARM="https://github.com/jgm/pandoc/releases/download/2.13/pandoc-2.13-linux-arm64.tar.gz"
PANDOC_WIN32_X64="https://github.com/jgm/pandoc/releases/download/2.13/pandoc-2.13-windows-x86_64.zip"
PANDOC_MACOS_X64="https://github.com/jgm/pandoc/releases/download/2.13/pandoc-2.13-macOS.zip"
...
then
    ...
    echo "Currently there is no ARM-release for macOS. Falling back to x64 ..." 1>&2 # Redirect echo's stdout to stderr
