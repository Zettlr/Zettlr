...
const tests = [
  // First general tests
  {
    input: Date.parse('09 Feb 2022 10:59:23 GMT'),
    relative: false,
    locale: 'en-US',
    expected: 'February 9, 2022 at 11:59 AM'
  },
  {
    input: Date.parse('09 Feb 2022 10:59:23 GMT'),
    relative: false,
    locale: 'de-DE',
    expected: '9. Februar 2022 um 11:59'
  },
  {
    input: Date.parse('01 Jan 1970 00:00:00 GMT'),
    relative: false,
    locale: 'en-US',
    expected: 'January 1, 1970 at 1:00 AM'
  },
